<template>
  <modal id="delete-result-KPI" ref="delete-result-KPI"  v-cloak>
...
import { GetKPIList,DeleteResult } from "@/api/kpiList";
...
export default {
  ...
  methods: {
    ...
    closeModal() {
      VoerroModal.hide('delete-result-KPI');
    },
    deleteTarget(){
      ...
      //console.log(this.form);
       DeleteResult(this.form).then(response => {
