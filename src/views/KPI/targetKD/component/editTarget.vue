<template>
  <modal id="edit-target-KPI" ref="edit-target-KPI"  v-cloak>
    <template slot="title">Chỉnh sửa tiêu chí</template>
    <div></div>
    <div slot="body">
      <el-form class="chi-tieu" ref="form"  label-width="120px" size="mini"> 
                ...
                <!-- <el-form-item label="KPI Code">
                 ...
                 <div>
               <div style="width=100px;float: left;" class="chi-tieu" >
                  <el-form-item label="Điểm KPI">
                  <el-input v-model="row.target" type="number" ></el-input>
                </el-form-item>
                 
               </div>
               <div style="width=100px;float: left;" class="month" >
    ...
    <div slot="footer" style="margin:10px;margin-left:auto;margin-right:20px">
      ...
      <el-button type="success" icon="el-icon-success" @click="editTarget" >Xác nhận</el-button>
    </div>
  </modal>
</template>
<script>
import { getEmployee } from "@/api/getEmployee";
import { GetKPIList,EditTarget } from "@/api/kpiList";
