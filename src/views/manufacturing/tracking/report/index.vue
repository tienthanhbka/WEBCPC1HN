<template>
  <div class="container">
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            ...
            >
              ...
              <el-table-column prop="TargetName" label="Chỉ tiêu">
                <template slot-scope="props">
                  {{ props.row.TargetName }}
                </template>
              </el-table-column>
              <el-table-column prop="Creator" label="Giá trị đo">
                <template slot-scope="props">
              ...
              <el-table-column prop="Unit" label="Kết quả">
                <template slot-scope="props">
                  {{ props.row.Unit }}
                </template>
              </el-table-column>
        ...
        <el-table-column label="Mã mẫu" min-width="70">
          <template slot-scope="scope">
            <div class="dat-cell" label="Mã mẫu">
              <el-button type="text" @click="detailReport(scope.row)">
                <el-link>{{ scope.row.SampleName }}</el-link></el-button
              >
            </div>
          </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormEvaluate" custom-class="default-modal">
      <span slot="title" style="font-weight:700;color: #02bc77;font-size: 20pt;"
