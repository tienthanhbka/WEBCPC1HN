             ...
             <el-table-column type="expand">
                <template slot-scope="props">
                     <p><b>Chi tiết đặt hàng</b></p>
                        <el-table :data="props.row.lines" style="width: 100%" v-loading="props.row.isLoading"
                    element-loading-text="Loading">
                        <el-table-column prop="Description"  label="Sản phẩm" width="180"></el-table-column>
                        <el-table-column prop="Quantity"  label="Số lượng" width="180"></el-table-column>
                        <el-table-column prop="unitMeasure"  label="Đơn vị" width="180"></el-table-column>
                        <el-table-column prop="unitPrice"  label="Giá" width="180"></el-table-column>
                         <el-table-column prop="amount"  label="Tổng giá" width="180"></el-table-column>
                          <el-table-column prop="amoutVAT"  label="Tổng giá VAT" width="180"></el-table-column>
...
<script>
    ...
    import { getExamDetail } from '@/api/examDetail'
