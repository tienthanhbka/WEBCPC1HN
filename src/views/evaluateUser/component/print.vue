<template>
  <div style="postion: relative">
    <div style="border: none;" ref="content">
      <div
        id="div_content_view"
        style="width:415.75px;padding:0 7.56px;box-sizing:border-box;display:flex;flex-wrap:wrap;"
        class="t-card"
      >
        <div v-for="(item, index) in EmployeeEvaluedLst" :key="index">
          <div
            style="width:132.28px;height:83.15px;text-align:center;padding:7.56px 0;"
          >
            <qrcode-vue
              id="report2"
