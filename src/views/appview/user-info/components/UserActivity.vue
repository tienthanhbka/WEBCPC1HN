        ...
        <div class="block">
          ...
          >
            ...
            <el-table-column label="Ngày sinh" align="left" min-width="120">
              <template slot-scope="scope">
                <div class="dat-cell" label="Ngày sinh">
            ...
            >
              <template slot-scope="scope"
                ><div class="dat-cell" label="Hộ khẩu thường trú">
      ...
      <el-tab-pane name="three" v-loading="updating">
        ...
        <div class="block">
          <el-table
            ...
            :show-header="true"
          >
            <el-table-column prop="Type" align="left" label="Quá trình ký HĐ">
              <template slot-scope="scope">
                <div class="dat-cell" label="Quá trình ký HĐ">
                  {{ scope.row.Type }}
                </div>
              </template>
            </el-table-column>
            <el-table-column label="Số HĐ" align="left">
              <template slot-scope="scope"
                ><div class="dat-cell" label="Số HĐ">
                  {{ scope.row.CodeWork }}
                </div></template
              >
            </el-table-column>
            ...
            <el-table-column label="Mức lương đóng BHXH" align="left">
              <template slot-scope="scope"
                ><div class="dat-cell" label="Múc lương đóng BHXH">
                  {{ scope.row.BHXH }}
                </div></template
              >
            </el-table-column>
      ...
      <el-tab-pane label="BHXH" name="four" v-loading="updating">
        ...
        <div class="block">
          <el-table
            ...
            :show-header="true"
          >
            <el-table-column prop="Money" align="left" label="Mức đóng">
              <template slot-scope="scope">
        ...
        <div class="block">
          ...
          >
            ...
            <el-table-column label="Ngày hiệu lực" align="left">
              <template slot-scope="scope"
                ><div class="dat-cell" label="Ngày hiệu lực">
                  {{ scope.row.DateStart }}
                </div></template
              >
            </el-table-column>
      ...
      <el-tab-pane label="Trạng thái" name="six" v-loading="updating">
        ...
        <div class="block">
          <el-table
            ...
            :show-header="true"
          >
            <el-table-column prop="Type" align="left" label="Trạng thái">
              <template slot-scope="scope">
