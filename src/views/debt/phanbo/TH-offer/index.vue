  ...
  <div>
    ...
    <div>
      ...
      >
              ...
              <div>
                ...
                <el-button
                  v-if="
                    scope.row.status != 10 &&
                      (scope.row.status == 1 ||
                        (scope.row.status < 6 && scope.row.lv == 2) ||
                        (scope.row.status < 7 && scope.row.lv == 4) ||
                        (scope.row.status < 9 && scope.row.lv == 5))
                  "
                  style="color:#c0392b"
                  type="text"
                  size="medium"
        ...
        <el-table-column prop="KH" label="KH" width="160" align="center">
