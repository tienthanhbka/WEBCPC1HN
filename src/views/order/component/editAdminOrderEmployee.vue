<template>
  <modal id="edit-request-modal" ref="edit-request-modal"  v-cloak>
      ...
      <el-form ref="form"  label-width="120px" size="mini">
                ...
                <el-form-item label="Yêu cầu">
                 ...
                 <el-form-item label="Ghi chú">
                  ...
                  <el-input type="number"  v-model="row.KPIBase" ></el-input>
                </el-form-item>
                  <el-form-item  label="Khối lượng">
                  <el-input  type="number" v-model="row.Rate" ></el-input>
                </el-form-item>
...
export default {
  ...
  methods: {
    ...
    closeModal() {
      VoerroModal.hide('edit-request-modal');
    },
    sendRequest(){
