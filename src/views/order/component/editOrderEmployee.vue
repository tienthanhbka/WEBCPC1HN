<template>
  <modal id="edit-request-modal-employee" ref="edit-request-modal-employee"  v-cloak>
    <template slot="title">Chỉnh sửa công việc</template>
    <div></div>
    <div slot="body">
...
export default {
  ...
  methods: {
    ...
    closeModal() {
      VoerroModal.hide('edit-request-modal-employee');
    },
    sendRequest(){
