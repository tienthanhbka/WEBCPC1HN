  ...
  <div slot="body">
    ...
    >
      <el-form-item label="Loại học tập">
        ...
        <el-radio v-model="form.productType" label="5"
          >Chia sẻ - câu hỏi lâm sàng</el-radio
        >
        <el-radio v-model="form.productType" label="6"
          >Sử dụng phần mềm</el-radio
        >
        <el-radio v-model="form.productType" label="7"
          >Bao bì sản phẩm</el-radio
        >
      </el-form-item>
      ...
      <el-form-item label="Slide">
        ...
        >
          <el-button size="small" type="warning"
            >Click to upload slide</el-button
          >
          <!-- <div slot="tip" class="el-upload__tip">jpg/png files with a size less than 500kb</div> -->
        </el-upload>
      </el-form-item>
      <el-form-item label="Video">
        ...
        >
          <el-button size="small" type="danger"
            >Click to upload video</el-button
          >
        </el-upload>
      </el-form-item>
    </el-form>
...
<script>
import { updateRegu2, getEmployeeDefine } from "@/api/regu";
...
export default {
  ...
  methods: {
    ...
    createRegu() {
      ...
      updateRegu2(this.form).then(response => {
