  ...
  <!-- <el-tooltip content="Tạo loại công việc"  placement="top"><el-button @click="openModalAction" type="text" > <i style="color: red" class="fas fa-plus"></i></el-button></el-tooltip> -->
        ...
        <!-- <el-table-column prop="GroupID" width="100" label="Nhóm"></el-table-column>
         <el-table-column width="100" prop="KPI" label="KPI"></el-table-column> -->
          <el-table-column prop="TimeCreate" label="Thời gian tạo"></el-table-column>
...
import { GetReportHeaderValueGroup,GetReportValue } from "@/api/report";
  ...
  methods: {
    ...
    fetchData() {
      var req = {
       ...
       GetReportHeaderValueGroup(req).then(response => {
