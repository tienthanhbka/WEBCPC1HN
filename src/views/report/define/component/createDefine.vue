<template>
  <div  shadow="always" style="margin: auto; position: relative;">
    ...
    <el-input placeholder="Nhập điểm KPI"  v-model="KPI"></el-input>
      <el-switch style="  margin-top:10px; display: inline-block;"  inactive-text="Public" v-model="Public"></el-switch>
  </div> 
      <div>
        ...
        <el-row style="margin-bottom: 20px;">
          ...
          <el-col :span="14">
            <div class="grid-content bg-purple-light">
              <el-input placeholder="Nhập tiêu đề nội dung (VD: Địa chỉ, Họ và tên,...)" v-model="line.question"></el-input>
            </div>
          </el-col>
         
          <el-col style="margin-left: 20px;" :span="6"><div class="grid-content bg-purple">
            <el-select v-model="line.type" placeholder="Chọn loại câu hỏi" @change="ChangeQuestion(index)">
              <el-option
                  v-for="item in types"
                  :key="item.value"
                  :label="item.label"
          ...
          <component :data="index" :is="line.currentComponent" @change="addOK"></component>
          <el-tooltip></el-tooltip>
           <el-switch style="float: right; margin-top:10px;"  inactive-text="Require" v-model="line.require"></el-switch>
...
import Question4 from "@/views/report/define/component/question4/index"
import Question5 from "@/views/report/define/component/question5/index"
