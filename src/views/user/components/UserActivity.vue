  ...
  <div class="container-activity">
    <el-tabs v-model="activeActivity" @tab-click="handleClick">
      <el-tab-pane name="first">
        <span slot="label" class="t-label-tabs"> Thông tin cá nhân</span>
        <div class="block">
          <el-table :data="infoT()" :show-header="false">
            ...
            <el-table-column label="Count" align="left">
              <template slot-scope="scope">
                <span class="no-data">{{ scope.row.value }}</span>
              </template>
            </el-table-column>
          </el-table>
        </div>
      ...
      <el-tab-pane name="second" v-loading="updating">
        <span slot="label" class="t-label-tabs"> Thông tin gia đình</span>
      ...
      <el-tab-pane name="three" v-loading="updating">
        ...
        <span slot="label" class="t-label-tabs">Quá trình ký HĐ</span>
        <div class="block">
...
export default {
  ...
  methods: {
    edit(row) {
      ...
      this.titleDialog = "Chỉnh sửa thông tin";
    },
    editOK() {
    ...
    del(row) {
      ...
      this.titleDialog = "Xóa thông tin";
    },
    delOK() {
    ...
    updateInfor() {
      ...
      this.titleDialog = "Cập nhật thông tin gia đình";
    },
    ...
    infoT() {
      return [
        {
          name: "MNV",
          value: this.user[0].EmployeeCode ? this.user[0].EmployeeCode : null
        },
        {
          name: "Email cá nhân",
          value: this.user[0].Email ? this.user[0].Email : null
        },
        {
          name: "Email công ty",
          value: this.user[0].EmailCompany ? this.user[0].EmailCompany : null
        },
        {
          name: "Link facebook",
          value: this.user[0].LinkFace ? this.user[0].LinkFace : null
        },
        {
          name: "Số CMND",
          value: this.user[0].CMND ? this.user[0].CMND : null
        },
        {
          name: "Ngày cấp",
          value: this.user[0].DateCMND
            ? Date.parse(this.user[0].DateCMND).toString("dd-MM-yyyy")
            : null
        },
        {
          name: "Nơi cấp",
          value: this.user[0].PlaceCMND ? this.user[0].PlaceCMND : null
        },
        {
          name: "Giới tính",
          value: this.user[0].Sex ? this.user[0].Sex : null
        },
        {
          name: "Quốc tịch",
          value: this.user[0].Nationality ? this.user[0].Nationality : null
        },
        {
          name: "Dân tộc",
          value: this.user[0].Folk ? this.user[0].Folk : null
        },
        {
          name: "Tôn giáo",
          value: this.user[0].Religion ? this.user[0].Religion : null
        },
        {
          name: "Tình trạng hôn nhân",
          value: this.user[0].Matrimony ? this.user[0].Matrimony : null
        },
        {
          name: "Ngày sinh",
          value: this.user[0].BirthDay
            ? Date.parse(this.user[0].BirthDay).toString("dd-MM-yyyy")
            : null
        },

        {
          name: "Nơi sinh",
          value: this.user[0].BirthAddress ? this.user[0].BirthAddress : null
        },
        {
          name: "Nguyên quán",
          value: this.user[0].Address ? this.user[0].Address : null
        },
        {
          name: "Hộ khẩu thường trú",
          value: this.user[0].AddressOften ? this.user[0].AddressOften : null
        },
        {
          name: "Nơi ở hiện nay",
          value: this.user[0].AddressNow ? this.user[0].AddressNow : null
        },
        {
          name: "Tình trạng sức khỏe",
          value: this.user[0].Health ? this.user[0].Health : null
        },
        {
          name: "Năng khiếu nổi bật",
          value: this.user[0].Gifted ? this.user[0].Gifted : null
        }
      ];
    },
    infoFamily() {
