  ...
  <div>
    <div class="user-profile">
        ...
        <div class="profile">
          <div class="profile--cover__image">
            <div v-if="displayUpdate" class=" text-center bt-update">
              <el-button
                v-if="user[0] && user[0].StatusWork != 'Đã nghỉ việc'"
                @click="updateInfor"
                type="text"
                size="mini"
                style="color:#fff"
      ...
      <div class="box-social">
        ...
        <p v-if="user[0].Note" class="notification">
      ...
      <el-dialog :visible.sync="dialogFormUpdate" custom-class="big-modal">
...
<script>
import UpdateInfor from "@/views/user/components/updateInfoEm";
