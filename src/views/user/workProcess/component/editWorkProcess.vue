...
<script>
import { EditEmployeeProcessWork } from "@/api/employeeInfor";
...
export default {
  ...
  methods: {
    modalOK() {
      ...
      EditEmployeeProcessWork(this.form).then(res => {
        this.$notify({
          title: "Thành công",
        ...
        this.row.DateSign = this.form.DateSign;
        this.row.BHXH = this.form.BHXH;
        this.row.CodeWork = this.form.CodeWork;
