<template>
  <modal id="delete-employee" ref="delete-employee"  v-cloak>
    <template slot="title">Xóa nhân viên khỏi nhóm</template>
   
    <div slot="body">
      <el-form ref="form"  label-width="120px" size="mini"> 
                 <el-form-item label="Xóa nhân viên">
                  <el-input type="textarea"
                  v-model="row.nameEmployee" ></el-input>
                </el-form-item>
              </el-form>
    </div>
    ...
    <div slot="footer" style="margin:10px;margin-left:auto;margin-right:20px">
      ...
      <el-button type="success" icon="el-icon-success" @click="deleteEmployee" >Xác nhận</el-button>
    </div>
  </modal>
</template>
<script>
