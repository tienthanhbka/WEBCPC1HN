<template>
  <div class="my-mission-container">
    <div>
      <addEmployeeGroup :groups="this.groups" @click-something="addOK"></addEmployeeGroup>
      <deleteEmployeeGroup :groups="this.groups" :row="this.rowData" @click-something="deleteOK"></deleteEmployeeGroup>
    ...
    <div style="margin-top: 20px;">
      ...
      >
        ...
        <el-table-column align="center" width="75px" label="" v-if="checkOTC!='KD'">
           <template slot-scope="scope">
             <div class="dat-cell" label="Action">
            <el-tooltip content="Chỉnh sửa" placement="top"><el-button @click="openModalEditOrderSend(scope.row)" type="text" > <i class="fas fa-edit"></i></el-button></el-tooltip>
        ...
        <el-table-column prop="nameEmployee" label="Tên nhân viên" align="center">
          <template slot-scope="scope">
...
export default {
  name: "SplitGroup",
  components: {
    AddEmployeeGroup,DeleteEmployeeGroup
  },
  data() {
    return {
       groupList: [],
