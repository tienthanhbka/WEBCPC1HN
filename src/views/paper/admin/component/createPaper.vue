...
<script>
import Question1 from "@/views/paper/component/Question1";
import Question2 from "@/views/paper/component/Question2";
import Question3 from "@/views/paper/component/Question3";
