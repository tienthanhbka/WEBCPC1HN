<template>
  <div class="container">
    ...
    <el-dialog :visible.sync="dialogFormAddUser">
      <span slot="title" style="font-weight:700;color: #02bc77;font-size: 20pt;"
        ><i class="fas fa-list"></i>&#32;&#32;Danh sách NCV theo dõi ý tưởng
      </span>
      <researcher-lst
        :idea="rowData"
        @addUserOK="addUserOK"
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item>
                    <el-button
                      ...
                      size="mini"
                      ><i class="fas fa-list"></i>Danh sách NCV</el-button
                    >
                  </el-dropdown-item>
                  <el-dropdown-item>
                    <router-link
