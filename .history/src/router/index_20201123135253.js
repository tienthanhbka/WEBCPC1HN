    ...
    children: [
      {
        ...
        children: [
          {
            path: "/hanh-chinh/giay-to/dinh-nghia",
            component: () => import("@/views/paper/index"),
            name: "Định nghĩa",
            meta: { title: "Định nghĩa", icon: "fas fa-file-signature" },
            children: [
              {
                path: "/hanh-chinh/giay-to/dinh-nghia/tao-moi",
                component: () => import("@/views/paper/component/createPaper"),
                name: "Tạo mới",
                meta: { title: "Tạo mới", icon: "fas fa-feather-alt" }
              },
              {
                path: "/hanh-chinh/giay-to/dinh-nghia/quan-ly",
                component: () => import("@/views/paper/admin/index"),
                name: "Quản lý",
                meta: { title: "Quản lý", icon: "far fa-folder-open" }
              }
            ]
          },
          {
            path: "/hanh-chinh/giay-to/danh-sach",
            component: () =>
              import("@/views/paper/employee/index"),
            name: "Danh sách",
            meta: { title: "Danh sách", icon: "far fa-file-alt" }
          },
        ]
      },
      {
