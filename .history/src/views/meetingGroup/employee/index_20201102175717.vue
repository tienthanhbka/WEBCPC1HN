...
export default {
  ...
  methods: {
    ...
    create() {
      if (this.tableData.length < 2 || this.groups == "CNHN-CONGNO") {
        ...
        this.$message({
          message:
            ...
            Date.parse(this.month).toString("MM"),
          type: "warning"
        });
      }
    },
