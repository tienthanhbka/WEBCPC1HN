<template>
  <el-card v-if="user">
    <el-tabs v-model="activeActivity" @tab-click="handleClick">
      <el-tab-pane label="Thông tin cá nhân" name="first">
        <div class="block">
      ...
      <el-tab-pane label="Thông tin gia đình" name="second" v-loading="updating">
          <div class=" text-center">    <el-button @click="updateInfor" size="mini" type="primary" plain><i class="far fa-edit"></i> Cập nhật</el-button> </div>
            <div class="block">
         <el-table :data="infoFamily()" :show-header="true">
            <el-table-column prop="RelativePosition" align="left" label="">
               <template slot-scope="scope">
              <el-tooltip content="Chỉnh sửa thông tin"> <el-button @click="edit(scope.row)" size="mini" type="success" ><i  class="fas fa-user-edit"></i></el-button></el-tooltip>
              <el-tooltip content="Xóa thông tin"> <el-button @click="del(scope.row)" size="mini" type="danger" ><i class="far fa-trash-alt"></i></el-button></el-tooltip>
              </template>
            </el-table-column>
          <el-table-column prop="RelativePosition" align="left" label="Người thân">
            <template slot-scope="scope">{{ scope.row.RelativePosition.slice(4) }}</template>
          </el-table-column>
          <el-table-column label="Họ và tên"  align="left" >
            <template slot-scope="scope">{{ scope.row.RelativeName }}</template>
          </el-table-column>
            <el-table-column label="Số điện thoại"  align="left" >
            <template slot-scope="scope">{{ scope.row.RelativePhone }}</template>
          </el-table-column>
            <el-table-column label="Ngày sinh"  align="left" >
            <template slot-scope="scope">{{ scope.row.RelativeBirth }}</template>
          </el-table-column>
            <el-table-column label="Giới tính"  align="left" >
            <template slot-scope="scope">{{ scope.row.RelativeSex }}</template>
          </el-table-column>
            <el-table-column label="Hộ khẩu thường trú"  align="left" >
            <template slot-scope="scope">{{ scope.row.RelativeAddress }}</template>
          </el-table-column>
             <el-table-column label="Nghề nghiệp"  align="left" >
            <template slot-scope="scope">{{ scope.row.RelativeJob }}</template>
          </el-table-column>
        </el-table>
        </div>
      </el-tab-pane>

      <el-tab-pane label="Quá trình ký HĐ" name="three" v-loading="updating">
          <!-- <div class=" text-center">    <el-button @click="updateInfor" size="mini" type="primary" plain><i class="far fa-edit"></i> Cập nhật</el-button> </div> -->
            <div class="block">
         <el-table :data="infoProcess()" :show-header="true">
          <el-table-column prop="Type" align="left" label="Quá trình ký HĐ"></el-table-column>
      ...
      <el-tab-pane label="BHXH" name="four" v-loading="updating">
         ...
         <el-table :data="infoBHXH()" :show-header="true">
          <el-table-column prop="Money" align="left" label="Mức đóng"></el-table-column>
          <el-table-column label="Từ ngày"  align="left" >
            <template slot-scope="scope">{{ scope.row.DateStart }}</template>
          </el-table-column>
            <el-table-column label="Đến ngày"  align="left" >
      ...
      <el-tab-pane label="Quyết định NS" name="fire" v-loading="updating">
         ...
         <el-table :data="infoDecision()" :show-header="true">
          <el-table-column prop="DecisionName" align="left" label="Loại quyết định"></el-table-column>
          <el-table-column label="Số quyết định"  align="left" >
            <template slot-scope="scope">{{ scope.row.DecisionNumber }}</template>
          </el-table-column>
            ...
            <template slot-scope="scope">
                <el-tooltip content="Xem chi tiết"><router-link :to="'/chi-tiet-quyet-dinh-nhan-su/'+ scope.row.RowID"> <el-button size="mini" type="warning" ><i class="far fa-eye"></i></el-button></router-link></el-tooltip>
                </template>
          </el-table-column>
        </el-table>
        </div>
      ...
      <el-tab-pane label="Trạng thái" name="six" v-loading="updating">
         ...
         <el-table :data="infoStatus()" :show-header="true">
          <el-table-column prop="Type" align="left" label="Trạng thái"></el-table-column>
     ...
     <el-dialog title="Cập nhật thông tin gia đình" :visible.sync="dialogFormUpdate">
