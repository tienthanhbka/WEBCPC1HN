  ...
  <div v-if="user" class="container-activity">
    <el-tabs v-model="activeActivity" @tab-click="handleClick">
      ...
      <el-tab-pane name="second" v-loading="updating">
        ...
        <div class="block">
          <el-table :data="infoFamily()" :show-header="true" width="100%" fit>
            <el-table-column
            ...
            <el-table-column label="Họ và tên" align="left" min-width="120px">
              <template slot-scope="scope">{{
            ...
            <el-table-column label="Ngày sinh" align="left" min-width="120px">
              <template slot-scope="scope">{{
                scope.row.RelativeBirth
              }}</template>
            </el-table-column>
            <el-table-column label="Giới tính" align="left" min-width="80px">
              <template slot-scope="scope">{{
            ...
            <el-table-column label="Nghề nghiệp" align="left" min-width="120px">
              <template slot-scope="scope">{{
