      ...
      <el-row>
        ...
        <el-col v-if="mst == 1" :xs="24" :lg="12">
           <!-- <el-form-item v-if="mst == 1" label="Nhập MST">
            ...
            <span style="width: 30%;">Nhập MST: </span><el-input style="width: 70%;"  size="mini" placeholder="Nhập MST" v-model="form.MST"></el-input>
       ...
       <el-row style="margin-top:10px;">
        ...
        <el-col v-if="bhxh == 1" :xs="24" :lg="12">
           ...
           <span style="width: 30%;">Nhập mã BHXH: </span><el-input style="width: 70%;"  size="mini" placeholder="Nhập mã BHXH" v-model="form.BHXH"></el-input>
        </el-col>
        </el-row>
          <el-row>
        <el-col :xs="24" :lg="6">  
...
import { GetPlace,GetBranch,GetOffice,GetPosition,AcceptInforHC } from '@/api/employeeInfor'
