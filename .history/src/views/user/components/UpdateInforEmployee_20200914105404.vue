      ...
      <el-row >
        <el-col :xs="24" :lg="8">
           <el-form-item label="Tôn giáo" prop="Religion">
              <el-select v-model="form.Religion" placeholder="Chọn tôn giáo"  style="width:100%">
                <el-option
...
import { toUpperCaseString } from '@/api/index'
...
export default {
    ...
    data(){
        return{
          ...
          bhxh:null,
            ...
            PlaceCMND:[{city:'Cục trưởng Cục cảnh sát ĐKQL cư trú và DLQG về dân cư'},{city:'Cục trưởng Cục cảnh sát Quản lý hành chính về trật tự xã hội'},{city:'CA Tỉnh Hòa Bình'},{city:'CA Tỉnh Sơn La'},{city:'CA Tỉnh Điện Biên'},{city:'CA Tỉnh Lai Châu'},{city:'CA Tỉnh Lào Cai'},{city:'CA Tỉnh Yên Bái'},{city:'CA Tỉnh Phú Thọ'},{city:'CA Tỉnh Hà Giang'},
            {city:'CA Tỉnh Tuyên Quang'},{city:'CA Tỉnh Cao Bằng'},{city:'CA Tỉnh Bắc Kạn'},{city:'CA Tỉnh Thái Nguyên'},{city:'CA Tỉnh Lạng Sơn'},{city:'CA Tỉnh Bắc Giang'},{city:'CA Tỉnh Quảng Ninh'},{city:'CA TP Hà Nội'},{city:'CA Tỉnh Bắc Ninh'},{city:'CA Tỉnh Hà Nam'},
            {city:'CA Tỉnh Hải Dương'},{city:'CA Tỉnh Hải Phòng'},{city:'CA Tỉnh Hưng Yên'},{city:'CA Tỉnh Nam Định'},{city:'CA Tỉnh Thái Bình'},{city:'CA Tỉnh Vĩnh Phúc'},{city:'CA Tỉnh Ninh Bình'},{city:'CA Tỉnh Thanh Hóa'},{city:'CA Tỉnh Nghệ An'},{city:'CA Tỉnh Hà Tĩnh'},
            {city:'CA Tỉnh Quảng Bình'},{city:'CA Tỉnh Quảng Trị'},{city:'CA Tỉnh Thừa Thiên Huế'},{city:'CA TP Đã Nẵng'},{city:'CA Tỉnh Quảng Nam'},{city:'CA Tỉnh Quảng Ngãi'},{city:'CA Tỉnh Bình Định'},{city:'CA Tỉnh Phú Yên'},{city:'CA Tỉnh Khánh Hòa'},{city:'CA Tỉnh Ninh Thuận'},
            {city:'CA Tỉnh Bình Thuận'},{city:'CA Tỉnh Kon Tum'},{city:'CA Tỉnh Gia Lai'},{city:'CA Tỉnh Đắk Lắk'},{city:'CA Tỉnh Đắk Nông'},{city:'CA Tỉnh Lâm Đồng'},{city:'CA TP Hồ Chí Minh'},{city:'CA Tỉnh Bà Rịa Vũng Tàu'},{city:'CA Tỉnh Bình Dương'},{city:'CA Tỉnh Bình Phước'},
            {city:'CA Tỉnh Đồng Nai'},{city:'CA Tỉnh Tây Ninh'},{city:'CA Tỉnh An Giang'},{city:'CA Tỉnh Bạc Liêu'},{city:'CA Tỉnh Bến Tre'},{city:'CA Tỉnh Cà Mau'},{city:'CA Tỉnh Cần Thơ'},{city:'CA Tỉnh Đồng Tháp'},{city:'CA Tỉnh Hậu Giang'},{city:'CA Tỉnh Kiên Giang'},
            {city:'CA Tỉnh Long An'},{city:'CA Tỉnh Sóc Trăng'},{city:'CA Tỉnh Tiền Giang'},{city:'CA Tỉnh Trà Vinh'},{city:'CA Tỉnh Vĩnh Long'},],
            Degree:[],
            DH:[],
            Specialized:[],
            SpecializedFather:[],
    ...
    methods:{
      ...
      querySearch6(queryString, cb) {
        ...
        var results = queryString ? links.filter(this.createFilter6(queryString)) : links;
        cb(results);
      },
      handleIconClick6(ev) {
        //console.log(ev);
  ...
  console.log(this.Folk)
        if(this.form.Nationality !== "Việt Nam"){
          this.Folk=[]
        }else{
          this.Folk=[{value: 'Kinh'},{value: 'Tày'},{value: 'Thái'},{value: 'Mường'},{value: 'Hoa'},{value: 'Khmer'},{value: 'Nùng'},{value: 'HMông'},{value: 'Dao'},{value: 'Gia-rai'},
            {value: 'Ê-đê'},{value: 'Ba-na'},{value: 'Sán chay'},{value: 'Chăm'},{value: 'Xê-đăng'},{value: 'Sán Dìu'},{value: 'Hrê'},{value: 'Cơ-ho'},{value: 'Ra Glay'},{value: "M'Nông"},
            {value: 'Thổ'},{value: 'Xtiêng'},{value: 'Khơ Mú'},{value: 'Bru-Vân Kiều'},{value: 'Giáy'},{value: 'Cơ-tu'},{value: 'Gié-Triêng'},{value: 'Tà Ôi'},{value: 'Mạ'},{value: 'Co'},
            {value: 'Chơ Ro'},{value: 'Hà Nhì'},{value: 'Xinh Mun'},{value: 'Chu-ru'},{value: 'Lào'},{value: 'La Chí'},{value: 'Phù Lá'},{value: 'La Hủ'},{value: 'Kháng'},{value: 'Lự'},
            {value: 'Pà Thẻn'},{value: 'Lô Lô'},{value: 'Chứt'},{value: 'Mảng'},{value: 'Cờ lao'},{value: 'Bố Y'},{value: 'La Ha'},{value: 'Cống'},{value: 'Ngái'},{value: 'Si La'},
       ...
       createFilter6(queryString) {
        ...
        var links = this.SpecializedFather;
        var results = queryString ? links.filter(this.createFilter8(queryString)) : links;
        cb(results);
      },
      handleIconClick8(ev) {
        //console.log(ev);
       ...
       handleSelect8(item) {
        this.form.SpecializedFather = item.value;
      ...
      handleIconClick5(ev) {
       ...
       querySearchFolk(queryString, cb) {
        var links = this.Folk;
        var results = queryString ? links.filter(this.createFilterFolk(queryString)) : links;
        cb(results);
      },
       ...
       createFilterFolk(queryString) {
        ...
        getPlace(){
          ...
          if(this.form.Position != null){
              if(this.form.Position.includes("ETC") || this.form.Position.includes("OTC") || this.form.Position.includes("PS") || this.form.Position.includes("GP")){
        ...
        initForm(){
          ...
          if(this.user[0].RowID){
            this.form.Status = this.user[0].Status
             ...
             this.form.EmployeeName= null
                ...
                this.form.BirthAddress=null
                this.form.BirthAddressCity=null
                this.form.BirthAddressDistrict=null
                this.form.BirthAddressCommune=null
                this.form.Address=null
                this.form.AddressCity=null
                this.form.AddressDistrict=null
                this.form.AddressCommune=null
                this.form.AddressOften=null
                this.form.AddressOftenCity=null
                this.form.AddressOftenDistrict=null
                this.form.AddressOftenCommune=null
                this.form.AddressNow=null
                this.form.AddressNowCity=null
                this.form.AddressNowDistrict=null
                this.form.AddressNowCommune=null
                this.form.Phone=null
                this.form.CMND=null
                this.form.DateCMND=null
                this.form.PlaceCMND=null
                this.form.Email=null
                this.form.Matrimony=null
                this.form.Health=null
                this.form.Qualification=null
                this.form.TrainingPlaces=null
                this.form.Specialized=null
                this.form.SpecializedFather=null
                this.form.Degree=null
                this.form.DegreeLevel=null
                this.form.TranningTime=[]
                this.form.Gifted=null
        ...
        modalOK(){
          ...
          this.form.EmployeeName = toUpperCaseString(this.form.EmployeeName);
           ...
           console.log(this.form)
            ...
            if(this.check()){
                ...
                if( this.form.Place!= null ){
                  if(Array.isArray(this.form.Place)){
            ...
            if( Array.isArray(this.form.TranningTime)){
              this.form.TranningTime=this.form.TranningTime.join(" đến ");
            }else{
              this.form.TranningTime=null
            }
            
               this.form.Address = this.form.Address + ", "+ this.form.AddressCommune+ ", " + this.form.AddressDistrict + ", " + this.form.AddressCity
             this.form.AddressOften = this.form.AddressOften + ", "+ this.form.AddressOftenCommune+ ", " + this.form.AddressOftenDistrict + ", " + this.form.AddressOftenCity
             this.form.AddressNow = this.form.AddressNow + ", "+ this.form.AddressNowCommune+ ", " + this.form.AddressNowDistrict + ", " + this.form.AddressNowCity
            //  if(this.form.Status == 2 ){
            //     UpdateInfor({form: this.form}).then(res=>{
            //       this.$notify({
            //           title:'Thành công',
            //           message: 'Cập nhật thành công. Vui lòng cập nhật thông tin gia đình',
            //           type:'success',
            //           position:'top-left'
            //       })
            //       alert('Bạn đã nhập thông tin cá nhân xong. Vui lòng cập nhập thông tin gia đình ở nút cập nhật trong phần Thông tin gia đình ở phí bên dưới!')
