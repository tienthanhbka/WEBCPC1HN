          ...
          function() {
            ...
            uploadTask.snapshot.ref
              ...
              .then(function(downloadURL) {
                _this.FeedbackProduct.LinkImageErr = downloadURL;
                console.log(_this.FeedbackProduct.LinkImageErr);
              });
          }
        );
      }
        ...
        uploadTask.on(
          ...
          function() {
            ...
            uploadTask.snapshot.ref
              .getDownloadURL()
              .then(function(downloadURL) {
                _this.FeedbackProduct.LinkBatchImage = downloadURL;
                console.log(_this.FeedbackProduct.LinkBatchImage);
              });
          }
        );
      }
          ...
          setTimeout(() => {
            db.ref(
            ...
            ).set(
              {
                ...
                LinkImageErr: this.FeedbackProduct.LinkImageErr,
                LinkBatchImage: this.FeedbackProduct.LinkBatchImage,
            ...
            this.FeedbackProduct.LinkImageErr = "";
            this.FeedbackProduct.LinkBatchImage = "";
