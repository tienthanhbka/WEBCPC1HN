    ...
    <div slot="body">
      <el-form ref="form" label-position="top" label-width="120px" size="mini"> 
                   ...
                   <el-radio v-model="form.productType" label="1">Sản phẩm</el-radio>
                    <el-radio v-model="form.productType" label="2">Kỹ năng</el-radio>
                </el-form-item>
              ...
              <div style="margin-top: 15px;">
               ...
               Tờ rơi
                ...
                :file-list="fileList2">
                <el-button size="small" type="success">Click to upload tờ rơi</el-button>
                <!-- <div slot="tip" class="el-upload__tip">jpg/png files with a size less than 500kb</div> -->
                </el-upload>
                </div>
         ...
         <div style="float: right"><el-button type="primary" icon="fas fa-plus"  @click="createRegu" > Xác nhận </el-button> </div>
    </div>
</template>
<script>
