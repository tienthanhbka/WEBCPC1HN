<template>
  <div class="container">
    ...
    >
      ...
      <el-table-column label="Loại phản hồi" width="120" align="center">
        <template slot-scope="scope">
    ...
    <div style="padding:5px;text-align:center;">
      <el-form-item size="large">
        <el-button type="danger" @click="cancel" icon="el-icon-circle-close"
          >Đóng</el-button
        >
      </el-form-item>
    </div>
    ...
    ExportExcel() {
      ...
      import("@/vendor/Export2Excel").then(excel => {
        excel.export_json_to_excel({
          ...
          filename: "Danh sách phản hồi về sản phẩm  " + this.product.Content,
          autoWidth: true,
          bookType: "xlsx"
        });
