    ...
    <div>
        <el-card >
            ...
            <div style=" font-size: 15px; margin-top: 10px; color: #777777;">
             ...
             <div style=" font-size: 15px; margin-top: 10px; color: #777777;">
                <span style="font-weight: bold;">Đối tượng áp dụng:</span> {{ this.lines.Office.replace(/;;/g,",") }}
            </div>
      ...
      <div>
          <el-card>
                <div style="width: 100%; height: 100%;"  class="grid-content bg-purple-light">
                    ...
                    <object :data="'https://icpc1hn.work/api/'+'File/GetFileRegu/'+line+'?token='+token" type="application/pdf" width="100%" height="1000px">
                    <p>Your web browser doesn't have a PDF plugin.
                    Instead you can <a :href="'https://icpc1hn.work/api/'+'File/GetFileRegu/'+line+'?token='+token">click here to
