      ...
      <div >
        ...
        <el-row style="margin-bottom: 20px;">
          ...
          <el-col :span="14">
                ...
                <div v-if="line.TypeQuestion == 1" class="grid-content bg-purple-light">
               ...
               <div v-if="line.TypeQuestion == 2" class="">
                   <el-radio-group v-model="line.answer"  v-for="(select, index) in line.select" :key="index">
                       <div style="width: 500px;">
                           <el-radio :label="select.IDSelect">{{ select.Name }}</el-radio>
                       </div>
                </el-radio-group>
<!-- 
             ...
             <div v-if="line.TypeQuestion == 3" class="grid-content bg-purple-light">
                 <el-checkbox-group v-model="line.answer"  >
                    <el-checkbox style="width: 500px;" v-for="select in line.select" :label="select.IDSelect" :key="select.IDSelect">{{select.Name}}</el-checkbox>
...
import { GetSurveyByID,SubmitSurvey,GetResponseSurveyByID,GetResult } from '@/api/survey'
