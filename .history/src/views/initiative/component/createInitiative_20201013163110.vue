    ...
    >
      <el-row :gutter="20">
        <el-col :xs="24" :sm="12" :lg="12">
          <el-form-item label="Tên đề xuất" prop="NameOffer">
            <el-input
              class="selectIDGroup"
        ...
        <el-col :xs="24" :sm="12" :lg="12">
          <el-form-item label="Phân loại" prop="TypeOffer">
            <el-select
              clearable
      ...
      <el-form-item label="Mô tả hiện trạng" prop="MoreInfo">
        <el-input
          class="selectIDGroup"
