      ...
      <el-table
        ...
        :data="
          OfferList.filter(
            data =>
              !TextSearch ||
              data.Creator.toLowerCase().includes(TextSearch.toLowerCase())
          )
        "
        style="width: 100%"
        border
        fit
      >
        <el-table-column min-width="50px" label="STT" align="center">
        ...
        <el-table-column
          ...
          :filters="[
            ...
            { text: 'Thực hiện ý tưởng', value: 'Thực hiện ý tưởng' }
          ]"
