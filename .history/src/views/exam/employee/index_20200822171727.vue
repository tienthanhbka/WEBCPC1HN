...
<div class="orderhcm-container">
    ...
    <div class="orderhcm-content">
        <el-table v-loading="listLoading" :data="examList" element-loading-text="Loading"
            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <div>
                        ...
                        <div style="color: red" class="inline-block"> {{props.row.point}} / {{props.row.pointMax}} </div>
                       <div class="inline-block"><b> <i class="el-icon-bottom" ></i> </b></div>
                        <div class="inline-block"><b>  Chi tiết bài thi:</b></div>
                    </div>

                         <el-table :data="props.row.line" style="width: 100%;" v-model="detailQuestion" v-loading="props.row.isLoading"
                    element-loading-text="Loading">
                        ...
                        <el-table-column prop="question"  label="Câu hỏi" style="color: bule" width="250"></el-table-column>
                         <el-table-column   label="Phương án lựa chọn">
                             <template slot-scope="scope">
                                <span>{{ scope.row.choiceAnswer | jsonParse }}</span>
                            </template>
                         </el-table-column>
                        <el-table-column prop="answer"  label="Đáp án chọn"></el-table-column>
                         <el-table-column prop="rightAnswer"  label="Đáp án đúng"></el-table-column>
                         <el-table-column prop="point"  label="Điểm" width="70" ></el-table-column>
        ...
        methods: {
            ...
            expandRow(row, expandedRows){
                 if (row.lines == null) {     
                    ...
                    row.isLoading=true;
                    examDetail({idCompetition : idCompetition,id: Cookies.get('idEmployee') ,token: Cookies.get('token')}).then(res => {
            ...
            // jsonParse(){
            //       var a= [{"A": "Kho 010109", "B": "Kho 010202", "C": "Kho 010107", "D": "Cả A+B" }]
            //          JSON.parse(a);
            //         alert(value);
            //         return value
            // }
