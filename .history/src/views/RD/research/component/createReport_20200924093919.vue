  ...
  methods: {
    uploadFirebase(file, fileList) {
      ...
      var uploadTask = storage
        .ref()
        .child(this.research.ResearchId + "/report")
        .put(file.file);
      uploadTask.on(
        "state_changed",
        function(snapshot) {
      ...
      db.ref("/ReportRD/" + v.toString(16)).set(
        {
          ...
          ContentEdit: this.form.ContentEdit,
          ReasonEdit: this.form.ReasonEdit,
          Comment: this.form.Comment,
          LinkReport: this.form.LinkReport,
          Creator:
            "[" + Cookies.get("employeeCode") + "]" + "-" + Cookies.get("name"),
