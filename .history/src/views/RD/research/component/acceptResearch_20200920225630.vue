      ...
      <div class="border-form">
        ...
        >
          <el-form-item label="Mã sản phẩm" prop="ProductId">
            <el-input v-model="form.ProductId" style="width:100%" disabled>
            </el-input>
          </el-form-item>
          <el-form-item label="Tên sản phẩm tham khảo" prop="ProductName">
            <el-input v-model="form.ProductName" style="width:100%" disabled>
            </el-input>
          </el-form-item>
          <el-form-item label="Hoạt chất chính" prop="ActiveElement">
            <el-input v-model="form.ActiveElement" style="width:100%" disabled>
            </el-input>
          </el-form-item>
          <el-form-item label="Hàm lượng" prop="Concentration">
            <el-input v-model="form.Concentration" style="width:100%" disabled>
            </el-input>
          </el-form-item>
          <el-form-item label="Dạng đóng gói" prop="Packing">
            <el-input v-model="form.Packing" style="width:100%" disabled>
            </el-input>
          </el-form-item>
        </el-form>
      </div>
