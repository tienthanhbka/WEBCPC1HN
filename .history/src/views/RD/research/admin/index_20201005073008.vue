<template>
  <div class="container">
    ...
    >
        ...
        <template slot-scope="scope">
          <div class="dat-cell" label="STT">
            ...
            <el-tooltip content="Chi tiết">
              <el-button @click="DetailResearch(scope.row)" type="text"
      ...
      <el-table-column label="Mã SP" min-width="80">
        <template slot-scope="scope">
          <div class="dat-cell" label="Mã SP">{{ scope.row.ProductId }}</div>
        </template>
      </el-table-column>
    ...
    <el-dialog :visible.sync="dialogFormAccept" custom-class="medium-modal">
      <span slot="title" style="font-weight:700;color: #02bc77;font-size: 20pt;"
        ><i class="fas fa-check-double"></i>&#32;&#32;Phê duyệt đề xuất
      </span>
      <accept-research
        :research="rowData"
        @acceptResearchOK="acceptResearched"
        @CancelFormAccept="CancelFormAccept"
      ></accept-research>
    </el-dialog>
    <el-dialog :visible.sync="dialogFormDetail" custom-class="medium-modal">
      <span slot="title" style="font-weight:700;color: #02bc77;font-size: 20pt;"
        ><i class="fas fa-check-double"></i>&#32;&#32;Chi tiết đề xuất sản phẩm
      </span>
      <detail-research
        :research="rowData"
