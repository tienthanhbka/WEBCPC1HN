<template>
   ...
   <div class= "container">
      ...
      <create :idea="rowData" modalId="new-idea-modal" @createIdeaOK="createIdeaOK" @updateIdeaOK="updateIdeaOK"></create>
...
export default {
  ...
  methods: {
    ...
    del(row) {
       this.$confirm('Xác nhận xóa ý tưởng '+row.IdeaName+'. Continue?', 'Xóa ý tưởng', {
