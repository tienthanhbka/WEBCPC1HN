  ...
  <div class="container">
    ...
    <div class="body">
      ...
      >
        ...
        <el-table-column label="Mã ý tưởng" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column label="Hoạt chất" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column label="Cách bào chế" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column label="Link" width="80" align="center">
          <template slot-scope="scope">
            <div class="dat-cell" label="Link">
              <el-link :href="scope.row.LinkIdea" v-if="scope.row.LinkIdea">
                LINK
              </el-link>
            </div>
          </template>
        </el-table-column>
        <el-table-column label="Khởi tạo" width="100" align="center">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    createIdea() {
      ...
      this.rowData = null;
      this.value = this.IdeaLst.length + 1;
    },
    editIdea(row) {
      VoerroModal.show("new-idea-modal");
      this.rowData = row;
    ...
    fetchData() {
      ...
      GetIdeaByUser({
        ...
        console.log(res.IdeaLst);
        this.IdeaLst = res.IdeaLst;
        console.log(this.IdeaLst.length);
