    ...
    <modal id="new-idea2-modal" ref="new-idea2-modal" v-cloak>
      ...
      <div slot="body" class="border-form">
        <el-form
          ...
          label-width="180px"
        >
          <el-form-item label="Mã ý tưởng" prop="IdeaName">
            <el-input
              class="selectIDGroup"
              v-model="form.IDIdea"
              style="width:100%"
          ...
          <el-form-item label="Link ý tưởng">
            <el-link :href="form.LinkIdea" target="_blank">{{
              form.LinkIdea
            }}</el-link>
          </el-form-item>
        </el-form>
  ...
  methods: {
    ...
    initForm() {
      if (this.idea) {
        ...
        this.form.DocumentId = this.idea.DocumentId;
        this.form.LinkIdea = this.idea.LinkIdea;
        this.form.IDIdea = this.idea.ReIDIdea;
      } else {
