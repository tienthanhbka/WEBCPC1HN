<template>
  <div class="container">
    ...
    >
      ...
      <!-- <el-table-column label="Loại nguyên liệu" min-width="100">
        <template slot-scope="scope">
          <div class="dat-cell" label="Loại nguyên liệu">
            {{ scope.row.TypeMaterial }}
          </div>
        </template>
      </el-table-column>
      <el-table-column label="Mã nguyên liệu" min-width="100">
        <template slot-scope="scope">
          <div class="dat-cell" label="Mã nguyên liệu">
      ...
      <!-- <el-table-column label="Giải thích" min-width="100">
        <template slot-scope="scope">
          <div class="dat-cell" label="Giải thích">
            {{ scope.row.DesIdentify }}
          </div>
        </template>
      </el-table-column>
      <el-table-column label="Mô tả thêm" min-width="100">
        <template slot-scope="scope">
          <div class="dat-cell" label="Mô tả thêm">{{ scope.row.Note }}</div>
        </template>
      </el-table-column> -->
    ...
    >
    <span slot="title" style="font-weight: bolder;color: brown;"><i class="el-icon-edit"></i>Cập nhật trạng thái</span>
      <create
        :material="rowData"
        @addMaterialOK="addOK"
    ...
    <el-dialog title="Xóa nguyên liệu" :visible.sync="dialogFormDel" custom-class="small-modal">
      <delete 
      
      :material="rowData" 
      @delMaterialOK="delOK"
      @deletecancelOK= "canceldelOK"
      ></delete>
    </el-dialog> -->
    <el-pagination
      class="pagination"
