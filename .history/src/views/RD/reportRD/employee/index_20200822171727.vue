<template>
    <div class="container">
      ...
      <div class="inline-block">
        <el-date-picker v-model="TimeEnd" type="date" placeholder="Đến ngày" size="mini">
        </el-date-picker>
      </div>
        <el-table 
        ...
        <createreport :report='data' @createcancelOK="CreateCancelOK"></createreport>
      ...
      <span slot="footer" class="dialog-footer">
       ...
       <el-dialog title="Xóa báo cáo" :visible.sync="dialogFormDel">
        <delete-report :report='data' @delReportOK="delOK" @deletecancelOK="delCancelOK"></delete-report> 
      <span slot="footer" class="dialog-footer">
      </span>
    </el-dialog>
    </div>
