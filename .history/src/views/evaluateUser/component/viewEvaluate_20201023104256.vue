s<template>
  <div style="font-family: arial,sans-serif,tahoma;">
    ...
    <div class="title-class">
      <span>Danh sách kết quả đánh giá: </span>
    </div>
    <div class="body">
      <el-table
      ...
      >
        ...
        <el-table-column min-width="100px" label="Định mức" prop="Postition">
          <template slot-scope="scope">
        ...
        <el-table-column width="180px" label="KQ đạt">
          <template slot-scope="scope">
        ...
        <el-table-column width="180px" label="Đánh giá">
          <template slot-scope="scope">
        ...
        <el-table-column width="180px" label="Nhận xét">
          <template slot-scope="scope">
