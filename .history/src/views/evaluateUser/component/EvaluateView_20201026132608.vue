        ...
        <div>
          ...
          <div style="text-align:center;">
            ...
            >
              <tbody>
                <tr>
                  <td style="width: 7.9174%;">
                    <div style="text-align: center;"><strong>STT</strong></div>
                  </td>
                  <td style="width: 20.654%;">
                    <div style="text-align: center;">
                      <strong>Ti&ecirc;u ch&iacute;</strong>
                    </div>
                  </td>
                  <td style="width: 10.327%; text-align: center;">
                    <div style="text-align: center;">
                      <strong>Đị** mức</strong>
                    </div>
                  </td>
                  <td style="width: 12.2203%; text-align: center;">
                    <div style="text-align: center;">
                      <strong>Kết quả đạt</strong>
                    </div>
                  </td>
                  <td style="width: 14.8021%; text-align: center;">
                    <div style="text-align: center;">
                  ...
                  <td style="width: 22.5474%; text-align: center;">
                    <div style="text-align: center;">
