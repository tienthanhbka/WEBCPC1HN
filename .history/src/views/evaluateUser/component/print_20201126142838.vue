<template>
  <div style="postion: relative">
    <div style="border: none;" ref="content">
      <el-card
        id="div_content_view"
        style="width:393.071px;padding:7.56px;"
        class="t-card"
      >
        <div
          style="width:188.98px;height:113.39px;border:1px dotted #ccc;text-align:center;"
        >
          <span style="padding:10px;font-weight:700;font-size:10pt;"
            >Bàn phím Logitech G613 Bàn phím Logitech G613</span
          >
          <qrcode-vue
            id="report2"
            ...
            style="padding:5px;"
          ></qrcode-vue>
          <span style="padding:10px 0;font-weight:700;font-size:10pt;"
