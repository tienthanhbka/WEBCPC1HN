      ...
      >
        <div>
          ...
          <div style="text-align:center;">
            ...
            <table style="width: 100%;">
              <tbody>
                <tr>
                  ...
                  <td style="width: 20.8262%;">
                    <div style="text-align: center;">
                      <strong>SL kế hoạch</strong>
                    </div>
                  </td>
                  <td style="width: 19.6213%; text-align: center;">
                    <div style="text-align: center;">
                      <strong>SL đạt</strong>
                    </div>
                  </td>
                  <td style="width: 30.4648%; text-align: center;">
                    <div style="text-align: center;">
                ...
                <tr>
                  <td style="width: 28.9157%; text-align: center;">
                  ...
                  <td style="width: 19.6213%;">
                    <div data-empty="true" style="text-align: right;">
                      <strong><br /></strong>
                    </div>
                  </td>
                  <td style="width: 30.4648%;">
                    <div data-empty="true" style="text-align: right;">
                      <strong><br /></strong>
                    </div>
                  </td>
                ...
                <tr>
                  <td style="width: 28.9157%;">Tổng ti&ecirc;u ch&iacute;</td>
                  <td style="width: 20.8262%;">
                    <div data-empty="true" style="text-align: right;">
                      <strong><br /></strong>
                    </div>
            ...
            <p><br /></p>
            <div class="ddict_btn" style="top: 35px; left: 130.391px;">
              <img
                src="chrome-extension://bpggmmljdiliancllaapiggllnkbjocb/icon/16.png"
              />
            </div>
          </div>
        </div>
