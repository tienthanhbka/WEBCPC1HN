<template>
  <div style="postion: relative">
    <div style="border: none;" ref="content">
      <div
        v-for="(item, index) in EmployeeEvaluedLst"
        :key="index"
        style="width:415.75px;padding:7.56px;box-sizing:border-box;display:flex;flex-wrap:wrap;"
      >
        <div
          id="div_content_view"
          style="width:100%;padding:7.56px;box-sizing:border-box;"
          class="t-card"
        >
