s<template>
  <div style="font-family: arial,sans-serif,tahoma;">
    ...
    <div class="body">
      ...
      >
        ...
        <el-table-column width="120px" label="Đánh giá" align="center">
          <el-table-column label="Tự động">
            <template slot-scope="scope">
              <div class="dat-cell" label="Tự động">
                <el-tag
                  :type="scope.row.RateAuto | toRateColor"
                  style="width:100px"
                  effect="plain"
                  >{{ scope.row.RateAuto | toRateText }}</el-tag
                >
              </div>
            </template>
          </el-table-column>
          <el-table-column label="Thủ công">
            <template slot-scope="scope">
    ...
    <div>
      <el-card class="box-card-list-item">
        <div slot="header" class="clearfix">
          <span style="color:#02bc77;font-size: 13.333px;font-weight: 700;"
