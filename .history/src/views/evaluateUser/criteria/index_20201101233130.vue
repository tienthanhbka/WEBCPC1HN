        ...
        <template slot-scope="scope">
          <div class="dat-cell" label="Tiêu chí">
            <p style="color: #02bc77;font-weight:700;">
              ...
              <span style="color:red;" v-if="scope.row.CriteriaType == 1"
                >*</span
              >
            </p>
            <span
            ...
            <p style="font-size:10pt;font-weight:700;" v-if="scope.row.Quota">
              Định mức:
              {{
      ...
      <el-table-column width="220px" label="Người đánh giá">
        <template slot-scope="scope">
          <div class="dat-cell" label="Người đánh giá">
            <p>{{ scope.row.EvalueTypeTxt }}</p>
            <span
              style="font-size:10pt;font-weight:700"
              v-if="scope.row.EvalueLevel"
              >Cấp bậc</span
            >
            <span>{{ scope.row.EvalueLevel | PositionStatusText }}</span>
          </div>
        </template>
      </el-table-column>
