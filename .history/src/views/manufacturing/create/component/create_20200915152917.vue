  ...
  <div class="container1">
    ...
    >
      <div class="border-form">
        <el-form-item label="Lệnh sản xuất" prop="Product">
          <el-autocomplete
          ...
          >
            ...
            <template slot-scope="{ item }">
              <div class="value">{{ item.External_Document_No_ }}</div>
        ...
        <el-form-item label="Lô sản xuất" prop="ProductionBatch">
          <el-input v-model="form.ProductionBatch"></el-input>
        </el-form-item>
        <el-form-item label="Bắt đầu BC" prop="DateStart">
        ...
        <el-form-item label="Kết thúc BC" prop="DateEnd">
          <div class="block-date-picker">
            <el-date-picker
