<template>
  <div>
    ...
    >
      <el-table-column label="Lệnh SX" prop="ProductName"> </el-table-column>
      <el-table-column label="Sản phẩm" prop="RegistrationNumber">
      </el-table-column>
      <!-- <el-table-column label="Hoạt chất" prop="Description"> </el-table-column>
      <el-table-column label="Hàm lượng" prop="Concentration">
      </el-table-column> -->
      <el-table-column label="Mã sản phẩm" prop="UnitOfMeasure">
      </el-table-column>
      <el-table-column label="Lô sản xuất" prop="ManufacturerName">
      </el-table-column>
    </el-table>
  </div>
</template>
