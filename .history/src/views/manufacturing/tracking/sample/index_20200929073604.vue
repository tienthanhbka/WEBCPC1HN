<template>
  <div class="container">
    ...
    <el-dialog :visible.sync="dialogFormTime" custom-class="default-modal">
      ...
      <time :sample="rowData" @cancel="cancelDetailOK"></time>
    </el-dialog>
    <el-pagination
      class="pagination"
      background
...
import Time from "../component/timeReport";
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      this.loading = true;
      let a = [];
      db.ref("ProductionOrderBFOLst").on("value", snap => {
        if (snap.val()) {
