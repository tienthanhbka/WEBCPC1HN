    ...
    >
      ...
      <el-card>
        ...
        >
          ...
          <el-row :gutter="20">
            <el-col :xs="24" :sm="12" :lg="12">
              <el-form-item label="Giá trị chuẩn" prop="Index">
                <el-input
                  v-model="Index.Index"
                  class="selectIDGroup"
                  style="width:100%"
            ...
            <el-col :xs="24" :sm="12" :lg="6">
              <el-form-item label="Đơn vị" prop="Index">
                <el-input
                  v-model="Index.Unit"
                  class="selectIDGroup"
                  style="width:100%"
            ...
            <el-col :xs="24" :sm="12" :lg="6">
              <el-form-item label="Sai số (%)" prop="Error">
                <el-input
                  v-model="Index.Error"
                  class="selectIDGroup"
                  style="width:100%"
        ...
        <el-col :span="24">
          <div>
            <el-table style="width: 100%" :data="IndexList">
              ...
              <el-table-column label="Giá trị chuẩn" width="120">
                <template slot-scope="scope">
                  {{ scope.row.Index }}
                </template>
              </el-table-column>
              ...
              <el-table-column label="Sai số" width="100">
                <template slot-scope="scope">
                  {{ scope.row.Error }}
                </template>
              </el-table-column>
            ...
            db.ref("/TargetList/" + v.toString(16)).set(
              {
                ...
                ProductOrder: this.Target.ProductOrder,
                Condition: this.Target.Condition,
            ...
            db.ref("/SampleList/" + this.sample.SampleID).update(
              {
                ...
                SampleID: this.sample.SampleID,
                ValObserved: this.sample.ValObserved,
                Creator: Cookies.get("idEmployee"),
                TimeUpdate: date.toLocaleString(),
                Status: 2,
                Note: this.sample.Note,
                TimeCreate: this.sample.TimeCreate
              },
              function(error) {
                if (error) {
                  console.log(error);
