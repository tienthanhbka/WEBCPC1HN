<template>
  <div class="container">
    ...
    >
      <el-table-column width="40px">
        <template slot-scope="scope">
          <div class="dat-cell">
            <router-link
              :to="'/san-xuat/bao-cao/ma-qr/' + scope.row.ReportDefineID"
              ><el-button type="text"><i class="fas fa-qrcode"></i></el-button
            ></router-link>
          </div>
        </template>
      </el-table-column>
        ...
        <template slot-scope="scope">
          <div class="dat-cell" label="Action">
            <el-tooltip content="Chỉnh sửa">
              <el-button @click="updateReportHeader(scope.row)" type="text"
    ...
    <el-dialog :visible.sync="dialogFormupdateReportHeader">
